...
# Using v10 (the strongest single model with CAMS-radiation) as the anchor,
# plus v8 + v11 for diversity (different feature subsets / model bias).
SOURCE_SUBS = [

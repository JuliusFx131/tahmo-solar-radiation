...
def main():
    ...
    BASE = [
        ...
        # v10: CAMS Solar Radiation Timeseries
        ...
        # v11: MERRA-2 speciated aerosols (different model than CAMS — diversity).
        # Drop ext_m2_aod_so4 (extraction had a naming issue — 0% coverage).

...
def main():
    ...
    BASE = [
        ...
        "ext_np_precip_corr",
        # v7: FORWARD-weather features (the test row's own future weather)
        # The change in temperature/humidity over the next 1h-3h carries a
        # direct measurement of the radiation right now. 100% coverage.

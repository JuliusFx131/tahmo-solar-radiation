"""
TAHMO Solar Radiation — LGBM + richer features (v1)
====================================================
...
Run:
  bash /workspace/shell/run_train_lgbm_feat_eng.sh

Outputs:
  /workspace/submissions/lgbm_feat_eng_v1.csv
  /workspace/submissions/lgbm_feat_eng_v1_log.txt
"""
